...
function getRootMetadata(lang: string): Metadata {
  const meta = metadataByLang[lang as keyof typeof metadataByLang] || metadataByLang.ru;

  return {
    title: { default: meta.defaultTitle, template: "%s | Hypertrade DEX Aggregator" },
...
export default async function RootLayout({ children, params }: { children: React.ReactNode; params: { lang: Language } }) {
